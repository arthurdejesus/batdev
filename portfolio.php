...
<div class="portfolio-section-holder animatedParent animateOnce" data-sequence="500">
    <div class="section section-intro section-portfolio-intro">
        <div class="container">
            <div class="content text-center p-0">
                <h3 class="primary-title animated fadeInUpShort slow" data-id="1">Domestic</h3>
            </div>
        </div>
    </div>
...
<div class="portfolio-section-holder animatedParent animateOnce" data-sequence="500">
    <div class="section section-intro section-portfolio-intro">
        <div class="container">
            <div class="content text-center p-0">
                <h3 class="primary-title animated fadeInUpShort slow" data-id="1">International</h3>
            </div>
        </div>
    </div>
    ...
    <div class="modal-gallery modal fade and carousel slide" id="lightbox2">
        <div class="modal-dialog">
            <div class="modal-content">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <div class="modal-body">
