<?php include 'header.php'; ?>
        ...
        <div class="section section-innovation" style="background-image: url('images/bg-innovation.jpg');">
            <div class="content-left">
                <h3 class="primary-title">innovation<br>
                    has  no limits</h3>
                <h4 class="secondary-title">The all-new, SKY PARK<br>
                    by Best American Trampolines</h4>
                <a href="#" class="btn btn-primary">Learn More</a>
            </div>
        </div>

        <div class="section section-process text-center">
            <div class="container">
                <div class="content">
        ...
        <div class="section section-client text-center">
            <div class="container">
                <div class="content">
                    <h3 class="primary-title">Our Clients</h3>
                    <div class="description">
                ...
                <a href="#" class="btn btn-primary">see more of our clients</a>
            </div>
        </div>
