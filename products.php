            ...
            <div class="bb-item">
                <div class="bb-item-bg">
                    <div class="slide-img" style="background: url(images/services/services1.jpg)">
                        <div>
                            <a href="product-individual.php"><span class="slidetext"><span>Trampoline Parks</span></span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bb-item">
                <div class="bb-item-bg">
                    <div class="slide-img" style="background: url(images/services/services2.jpg)">
                        <div>
                            <a href="ninja.php"><span class="slidetext"><span>Attractions</span></span></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bb-item">
                <div class="bb-item-bg">
                    <div class="slide-img" style="background: url(images/services/services3.jpg)">
                        <div>
                            <a href="portfolio-individual.php"><span class="slidetext"><span>Entertainment Centers</span></span></a>
                        </div>
                    </div>
                </div>
            </div>
