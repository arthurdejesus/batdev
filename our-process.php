            ...
            <div class="grid-we-do-img-wrap grid-wrap-black">
                ...
                <div class="product-content ">
                    ...
                    <div class="view-next view-design">
                        <a href="#design" class="btn btn-primary scroll">View Next Step<span class="arrow-down-view"></span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid-we-do-img-wrap grid-wrap-black">
                ...
                <div class="product-content">
                    ...
                    <div class="view-next view-deployment">
                        <a href="#deployment" class="btn btn-primary scroll">View Deployment<span class="arrow-down-view"></span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid-we-do-img-wrap grid-wrap-black">
                ...
                <div class="product-content">
                    ...
                    <div class="view-next view-guarantee">
                        <a href="#guarantee" class="btn btn-primary scroll">View Our Guarantee<span class="arrow-down-view"></span></a>
                    </div>
                </div>
            </div>
        </div>
